...
BLOG_AUTHOR = "Robot"  # (translatable)
BLOG_TITLE = "Mr.Robot"  # (translatable)
...
BLOG_EMAIL = "luoyupiaoshang@gmail.com"
BLOG_DESCRIPTION = "kS Web"  # (translatable)
